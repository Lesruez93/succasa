...
export default  function InvitePartner(props: any) {
    let newData: any = {};
    ...
    const [uid, setUID] = useState<any>(false);
        ...
        if (name || number || last_name) {
            ...
            if (validateEmail(email)) {
                const data = {
                    ...
                    "content": "Hi " + name + " \n" +
                        "\n" +
                        getUser().name + " has just invited you to join them on Sucasa as a partner. \n" +
                        "\n" +
                ...
                setShowLoading(true);
                firebase.firestore().collection('invites').add(data).then();
        ...
        <IonPage>
            <IonHeader className="ion-no-border">
                <IonToolbar>
                    ...
                    <IonTitle>Invite Partner</IonTitle>
                </IonToolbar>
            </IonHeader>
            <IonContent fullscreen>
                ...
                <div className={'ion-margin-top ion-padding'}>
                    ...
                    <IonItem lines={'none'}>
                        ...
                        <IonInput value={name} onIonChange={y => setText(y.detail.value!)}
                    ...
                    <IonItem lines={'none'}>
                        ...
                        <IonInput value={last_name} onIonChange={y => setLastName(y.detail.value!)}
                                  className='ion-margin-top input'/>
                    </IonItem>

                    <IonItem lines={'none'}>
                        <IonLabel position="stacked">Email</IonLabel>
                        <IonInput value={email} type='email' onIonChange={y => setEmail(y.detail.value!)}
                                  className='ion-margin-top input'/>
                    </IonItem>
                    ...
                    <IonButton disabled={!name || !last_name || !email || !number} onClick={e => {
                        e.preventDefault();
                        isSelected()

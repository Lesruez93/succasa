...
export default function  SendFeedback (props:any) {
                ...
                <IonContent fullscreen>
                    ...
                    <div className='ion-margin-top ion-padding' >
                        <div className='ion-text-center ion-margin-top '>
                            ...
                            <p>Feel free to give us your feedback or report any issues you have found on the app</p>

                        </div>

                        <IonItem lines={'none'}>
                            <IonLabel position="stacked">Feedback</IonLabel>
                            <IonInput value={subject} onIonChange={y => setText(y.detail.value!)} placeholder='Subject'

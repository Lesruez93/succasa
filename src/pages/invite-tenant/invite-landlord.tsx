...
export default function  InviteLandlord (props:any) {
    let newData :any = {};
           ...
           if (validateEmail(email)){
               const data =  {
                       ...
                       "from": getUser().name,
                           ...
                           "content": "Hi "+name+" \n" +
                               "\n" +
                               getUser().name + " has just invited you to join them on Sucasa as a landlord. \n" +
                               "\n" +
               ...
               setShowLoading(true);
                postData(data,'accountinvites').then(()=>{
                    ...
                    setMessage('Your landlord invitation email has been sent!');
                    setColor('success');

                            ...
                            <IonCard className={'ion-padding-left ion-card'}>
                                <IonItem color={'none'} lines={'none'}>
                                    <IonLabel className="ion-text-wrap">
                                        ...
                                        <p className='ion-padding-top'>Manage up to 5 property listings</p>
                                    </IonLabel>
                            ...
                            <IonCard className={'ion-padding-left ion-card'}>
                                <IonItem color={'none'} lines={'none'}>
                                    <IonLabel className="ion-text-wrap">
                                        ...
                                        <p className='ion-padding-top'> Manage up to 20 property listings</p>
                                    </IonLabel>
                            ...
                            <IonCard className={'ion-padding-left ion-card'}>
                                <IonItem color={'none'} lines={'none'}>
                                    <IonLabel className="ion-text-wrap">
                                        ...
                                        <p className='ion-padding-top'> Manage up to 50 property listings</p>
                                    </IonLabel>
